...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,        }, "/", function () awful.spawn("toggle-layout") end,
...
client.connect_signal("focus", function(c) draw_left_bar(c) end)

client.connect_signal("unfocus", function(c) draw_left_bar(c) end)

client.connect_signal("property::size", function(c) draw_left_bar(c) end)
