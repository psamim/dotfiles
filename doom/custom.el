(custom-set-variables
 ...
 '(org-agenda-files
   '("~/Notes/todo.org" "~/Notes/someday.org" "~/Notes/calendar-inbox.org" "~/Notes/events.org" "/home/samim/Notes/journal/daily/20210302.gpg"))
...
" :clock-keep t)))
 ...
 '(package-selected-packages
   '(ox-clip zen-mode web-mode org-pretty-tags org-msg org-beautify-theme olivetti oauth2 oauth moe-theme modus-themes modus-operandi-theme lastfm emojify dired-quick-sort centered-window bbdb))
 '(rustic-ansi-faces
